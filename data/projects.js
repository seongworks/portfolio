...
const PROJECTS = [
  ...
  {
    id: "p03",
    title: "Poverty Fighter",
    category: "웹 디자인",
    year: "2026",
    cover: "assets/img/projects/p03-cover.jpg",

    summary: "후원 플랫폼 웹사이트 UI 디자인 — 인트로부터 후원 완료까지 15개 화면",
    description: [
      "도움이 필요한 사람과 후원자를 연결하는 후원 플랫폼 'Poverty Fighter'의 웹사이트 디자인입니다. 화면 하나만 그리지 않고, 처음 들어와서 후원을 마칠 때까지 거치는 15개 화면을 전부 만들었습니다. 인트로 · 메인 · 로그인 · 회원가입 · 소개글 · 활동 지역 · 캠페인 상세 · 후원 4단계 · 마이페이지 · 문의하기 · 공지사항입니다.",
      "첫 화면은 흑백 사진 한 장으로 엽니다. 우는 아이의 얼굴을 오른쪽에 크게 두고, 왼쪽에 손글씨체로 '집에 돌아가고 싶어요.' 한 줄만 얹었습니다. 그 아래 버튼은 '후원하기'가 아니라 '아르가의 이야기 들어보기'입니다. 돈을 부탁하기 전에 사람을 먼저 보여주는 순서로 짰습니다.",
      "후원하기는 한 화면에 몰아넣지 않고 후원방법 → 정보입력 → 결제정보 → 후원완료 네 단계로 나눴습니다. 화면 위쪽에 네 단계를 항상 띄워두고 지금 있는 칸만 노랑으로 켜서, 입력할 게 많아도 얼마나 남았는지 보이게 했습니다. 완료 화면에는 금액 · 대상 · 날짜와 함께 후원 번호를 남겨, 영수증처럼 손에 쥐는 것이 있게 했습니다.",
      "'기적'이라는 말을 글 전체의 축으로 삼았습니다. 모든 화면 오른쪽 아래에 커피잔 아이콘의 동그란 버튼이 '커피 한잔의 기적 실현하기'로 떠 있고, 마지막 결제 버튼은 '결제하기'가 아니라 '기적 실천하기'입니다. 어느 화면에서 들어와도 같은 말로 이어지게 하려고 버튼 문구를 하나로 묶었습니다.",
      "색은 파랑 하나로 제한했습니다. 헤더 · 버튼 · 강조에만 쓰고 나머지는 흰 바탕에 검은 글씨로 두었습니다. 로고에만 파랑에서 보라로 넘어가는 그라데이션을 썼고, 인트로와 로그인처럼 로고가 주인공인 화면에서는 그 그라데이션으로 화면 전체를 채워 다른 페이지와 구분했습니다.",
      "활동 지역은 '도움을 받는 나라'와 '도움을 주는 나라' 두 갈래로 갈라 국기와 함께 세웠습니다. 캠페인 상세 페이지는 종이 질감 위에 '경제 대국 인도'와 '인도의 두 얼굴'을 나란히 놓아, 같은 나라의 두 면을 마주 보게 했습니다."
    ],

    tools: ["Adobe XD"],

    /* XD 아트보드 15장을 주제별로 묶었습니다. 웹 화면은 세로로 길어서
       한 장씩 두면 갤러리에서 가는 막대가 되기 때문에, 관련된 화면끼리
       나란히 붙여 한 장으로 만들었습니다.                              */
    images: [
      { src: "assets/img/projects/p03-01.jpg", caption: "메인 화면과 캠페인 상세 — 브릿지 인디아" },
      { src: "assets/img/projects/p03-03.jpg", caption: "후원하기 네 단계 — 후원방법 → 정보입력 → 결제정보 → 후원완료" },
      { src: "assets/img/projects/p03-02.jpg", caption: "인트로 · 로그인 · 회원가입" },
      { src: "assets/img/projects/p03-04.jpg", caption: "소개글과 활동 지역 — 도움을 받는 나라 · 주는 나라" },
      { src: "assets/img/projects/p03-05.jpg", caption: "마이페이지 · 문의하기 · 공지사항" }
    ],
