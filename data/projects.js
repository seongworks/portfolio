...
const PROJECTS = [
...

  {
    ...
    summary: "한국기술교육대학교 AI 굿즈 디자인 공모전 출품작 — 학교 캐릭터 '코리'로 만든 무드등과 키링",
    description: [
      "한국기술교육대학교 AI 굿즈 디자인 공모전에 출품한 작업입니다. 캐릭터를 새로 만드는 공모전이 아니라 학교가 이미 쓰고 있는 마스코트 '코리'를 굿즈로 옮기는 과제였습니다. 그래서 코리의 생김새와 색은 그대로 두고, 물건에 맞는 표정과 자세만 새로 그렸습니다. 이미지는 ChatGPT로 만들고 포토샵으로 다듬었습니다.",
      "무드등은 안에서 빛이 나오는 물건이라 두께가 곧 밝기가 됩니다. 몸통은 두껍게, 귀와 날개는 얇게 두어 불을 켜면 부분마다 밝기가 달라지고, 꺼 두면 그냥 인형처럼 보이게 했습니다. 켠 모습과 끈 모습을 함께 보여주는 것도 그래서입니다.",
      "키링은 아크릴로 실제로 제작해 봤습니다. 얼굴만 잘라 쓰되 기본 · 반짝 · 슬픔 세 가지 표정으로 나눠, 고르는 재미를 두면서도 셋이 나란히 있을 때 같은 캐릭터로 보이게 했습니다."
    ],
    ...
    images: [
      ...
      { src: "assets/img/projects/p08-02.jpg", caption: "코리 키링 — 표정 3종과 실물" }
    ],
