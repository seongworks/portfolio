...
const PROJECTS = [
...

  {
    ...
    summary: "한국기술교육대학교 AI 굿즈 디자인 공모전 출품작 — 캐릭터를 실리콘 무드등으로",
    description: [
      "한국기술교육대학교 AI 굿즈 디자인 공모전에 출품한 작업입니다. ChatGPT로 이미지를 만들고 포토샵으로 다듬어, 캐릭터를 실리콘 무드등 형태의 굿즈로 제안했습니다.",
      "안에서 빛이 나오는 물건이라 두께가 곧 밝기가 됩니다. 몸통은 두껍게, 귀와 날개는 얇게 두어 불을 켰을 때 부분마다 밝기가 달라지도록 형태를 잡았습니다. 선을 얹어 표현하는 대신 덩어리 자체로 읽히게 한 것도 같은 이유입니다."
    ],
