...
const PROJECTS = [
...

  {
    ...
    description: [
      "수업 과제로 만든 자동차 광고 포스터입니다. 확대를 주제로 잡고, 맥라렌 W1 한 대를 배율만 바꿔 세 번 담았습니다. 맨 위는 차체와 휠이 화면을 가득 채울 만큼 바짝 당긴 컷, 가운데는 뒤쪽 절반, 맨 아래는 차 전체입니다.",
...

  {
    ...
    category: "광고 · 포스터 · 간판",
    year: "2026",
    cover: "assets/img/projects/p10-cover.jpg",

    summary: "팝아트 기법으로 다시 만든 코카콜라 포스터",
    description: [
      "수업 과제로 만든 코카콜라 광고 포스터입니다. 팝아트 기법으로, 사진을 그대로 쓰지 않고 색 단계를 줄여 판화처럼 바꾼 뒤, 인쇄 망점을 크게 키운 무늬를 배경에 깔았습니다.",
      "배경은 가운데에서 바깥으로 뻗는 빛살로 잡고 분홍 · 노랑 · 파랑 · 자홍을 번갈아 채웠습니다. 색이 많아 어지러울 수 있어서 병만 초록과 검정으로 남기고 흰 테두리를 둘렀습니다. 배경이 아무리 시끄러워도 병은 앞으로 떠오릅니다.",
      "로고는 병 뒤에 크게 흘려 써 반쯤 가렸습니다. 다 보이지 않아도 무엇인지 아는 글자라, 가려질수록 오히려 시선이 병으로 모입니다."
    ],

    tools: ["Photoshop"],

    /* 시안이나 과정 컷이 있으면 p10-01.jpg 처럼 올리고
       아래에 줄을 추가하면 이어서 나옵니다.                           */
    images: [
      { src: "assets/img/projects/p10-cover.jpg", caption: "포스터 전체" }
    ],
