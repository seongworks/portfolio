...
const PROJECTS = [
...

  {
    ...
    description: [
      ...
      "얼굴이 가려져 있으면 표정으로 감정을 전할 수 없습니다. 그래서 그 역할을 비율과 실루엣에 맡겼습니다. 8등신으로 길게 뺀 몸, 회색 상자로 가린 머리, 낡은 검정 셔츠에 맨 노란 넥타이, 어깨에 걸친 낫 — 서로 어울리지 않는 요소를 한 인물에 모아, 겉모습만으로는 성격을 단정하기 어렵게 만들었습니다.",
